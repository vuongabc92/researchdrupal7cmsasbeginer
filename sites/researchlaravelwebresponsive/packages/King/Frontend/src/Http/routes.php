...
Route::group(['middleware' => 'auth'], function(){
    Route::group(['prefix' => 'setting'], function($route){
        ...
        //Route::group(['middleware' => 'store_owner'], function($route){
            ...
            $route->get('find-product-by-id/{id}', ['as' => 'front_product_byid', 'uses' => 'StoreController@ajaxFindProductById']);
...
Route::get('find-product-by-id/{id}/{full}', ['as' => 'front_full_product_byid', 'uses' => 'StoreController@ajaxFindProductById']);
