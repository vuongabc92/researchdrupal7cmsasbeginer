        ...
        <div class="_fwfl _bgw _r0 modal-content">
            ...
            <div class="-qvp-modal-right">
                ...
                <span class="_fwfl qvp-view-all-comment">
                    <button class="-qvp-view-more-comments" id="qvp-load-comments" data-text="View all __COUNT comments" data-text-2="Load more comments" data-current="1" data-url data-load-more-comments></button>
                </span>
